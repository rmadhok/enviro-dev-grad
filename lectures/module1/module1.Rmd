...
- Set the stage: 
  - how does development affect the environment (module 2)
  - how does environment affect development ($\frac{\partial h}{\partial e}$) (module 3)
...
\vfill
- High MUC **does not** mean deviation from first best 
