...
- Education
  - BA in Economics and Environmental Studies at McGill University (Montreal)
  - MA and PhD at University of British Columbia (Vancouver)
\vfill
...
- Name, year, memorable summer activity
\vfill
...
\vfill
- **Office Hours:** Tues/Thurs 11:30am-12:30pm, Ruttan 337D
\vfill
...
- Environmental quality is worse and has worse consequences in LMICs
  ...
  - Pressing need for conservation policy as LMICs grow/urbanize
...
- Lecture 6: Revealed preference approaches (structural)
...
- Last time student's published their paper!
  - JCRE special issue on PES (open through Jan 2027)

## Mcway and Braaksma (2025)

```{r replication, echo = FALSE, message = FALSE, warning = FALSE, out.width = "65%", fig.align = "center"}

knitr::include_graphics(
                        path = "assets/replication_example.png",
                        auto_pdf = TRUE
                        )
...
- 7 points for attendance, 3 points for engagement
  - in class engagement, office hrs, emails

- Attendance based on tiered schedule:

\begin{table}[h!]
\centering
\begin{tabular}{lcc}
\hline
\textbf{Classes Attended} & \textbf{Classes Missed} & \textbf{Attendance Points} \\
\hline
12--14 & 0--2   & 7/7 \\
9--11  & 3--5   & 5/7 \\
6--8   & 6--8   & 3/7 \\
...
- MWTP is low (paradox)
  ...
  - Braaksma, Mcway, Madhok, and Lasway (2026): 11 Rs. for biodiversity
...
1. High marginal utility of consumption \textcolor{red}{(efficient markets)}
  
2. High marginal abatement costs \textcolor{red}{(efficient markets)}

3. Political economy distortions \textcolor{red}{(first best violation)}

4. Market failures \textcolor{red}{(first best violation)}
...
- **Very** few revealed preference studies on $MWTP_{e}$
  ...
  - In progress: MWTP for biodiversity (Braaksma, Lasway, Madhok and McWay, 2026)
\vfill
...
- High MAC suggests sub-optimal environmental quality. Why?
    - Downward sloping MAC suggests low MC in poor countries

\vfill 

- MC not only driven by MAC; also reflects weak state capacity
  - Enforcement (Duflo et al., 2013)
  - Incentives (Gulzaar and Dipoppa, 2024)
...
- Many examples from LMICs
  ...
  - human-wildlife conflict (Madhok et al., 2026)
\vfill
